...
The waypoints are preprocessed by transforming them to the vehicle's co-ordinate system, where the vehicle is in the origin.

## Model Predictive Control with Latency
The latency is achived by computing the curent state of the vehicle model from the previous step having the delay of 1 second.
